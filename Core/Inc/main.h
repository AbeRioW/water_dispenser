...
#define LCD_EC_Pin GPIO_PIN_15
#define LCD_EC_GPIO_Port GPIOC
...
#define WATER_LAY_Pin GPIO_PIN_7
#define WATER_LAY_GPIO_Port GPIOB
#define FIRE_LAY_Pin GPIO_PIN_9
#define FIRE_LAY_GPIO_Port GPIOB
